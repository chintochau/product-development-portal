...
export const defaultPlatforms = ['BluOS', 'Desktop', 'iOS', 'Android']
...
export const defaultHardwareSteps = [
  ...
  },
  {
    ...
    subSteps: [
      {
        label: 'ES Schematics + Layouts + BOMs Created, Reviewed and Issued to Factory',
        completed: false
      },
  ...
  },
  {
    ...
    subSteps: [
      {
        label: 'PP Schematics + Layouts + BOMs Updated, Reviewed and Issued to Factory',
        completed: false
      },
  ...
  },
  {
    ...
    subSteps: [
      {
        label: 'MP Schematics + Layouts + BOMs Updated, Reviewed and Issued to Factory',
        completed: false
      },
